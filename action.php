                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<a> / Kilo</a></h4>
										...
										<div class='product-btns'>
											...
											<button pid='$pro_id' id='product' class='add-to-wishlist'><i class='fa fa-heart-o'></i><span class='tooltipp'>add to cart</span></button>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' onclick=\"window.location.href='cart.php'\"><i class='fa fa-shopping-cart'></i> buy now</button>
									</div>
								</div>
							</div>
			";
...
if (isset($_POST["Common"])) {
	...
	if(isset($_POST["buyNow"]) && isset($_POST["proId"])) {
		$p_id = $_POST["proId"];
		$ip_add = getenv("REMOTE_ADDR");
		...
		if(isset($_SESSION["uid"])){
			...
			mysqli_query($con, "INSERT INTO cart(p_id, ip_add, user_id, qty) VALUES ('$p_id','$ip_add','$user_id','1')");
		} else {
			mysqli_query($con, "DELETE FROM cart WHERE ip_add='$ip_add' AND user_id=-1");
			mysqli_query($con, "INSERT INTO cart(p_id, ip_add, user_id, qty) VALUES ('$p_id','$ip_add','-1','1')");
		}
