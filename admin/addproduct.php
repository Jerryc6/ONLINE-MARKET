...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
    ...
    VALUES 
    ('$product_type','$brand','$product_name','$price','$details','$pic_name','$tags','$product_quantity')")
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="">Product Source</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" id="product_quantity" name="product_quantity" required class="form-control" min="1">
                    </div>
                  </div>
