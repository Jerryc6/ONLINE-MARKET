		...
		<div class="section mainn mainn-raised">
			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=13"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop03.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Fruit<br>Products</h3>
								<a href="product.php?p=13" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=19"><div class="shop">
							<div class="shop-img">
								<img src="./img/shop02.png" alt="">
							</div>
							<div class="shop-body">
								<h3>Rice<br>Products</h3>
								<a href="product.php?p=19" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Per Kilo</del></h4>
