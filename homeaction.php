...
if(isset($_POST["categoryhomee"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li class='active'><a href='store.php'>All Products</a></li>
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "        
               <li class='categoryhomee' cid='$cid'><a href='store.php'>$cat_name</a></li>       
			";
		}
...
if(isset($_POST["getProducthomee"])){
	$limit = 3;
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price<a> / Kilo</a></h4>
									</div></a>
								</div>
...
if(isset($_POST["gethomeProductt"])){
	$limit = 9;
	if(isset($_POST["setPage"])){
		$pageno = $_POST["pageNumber"];
		$start = ($pageno * $limit) - $limit;
...
if(isset($_POST["get_seleted_Categoryy"]) ||  isset($_POST["search"])){
